...
namespace TheKoans
{
    ...
    public class AboutMethods : KoanHelper
    {
        ...
        {
            CollectionAssert.AreEqual(new string[] { "Cory", "Will", "Corey" }, this.LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
        }
        ...
        {
            CollectionAssert.AreEqual(new string[] { "Cory", "Will", "Corey" }, LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
        }
